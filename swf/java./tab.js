...
box-shadow: 3px 3px 3px 3px #000000 inset;/* FF3.5+, Opera 9+, Saf1+, Chrome, IE10 */
filter: progid:DXImageTransform.Microsoft.Shadow(Strength=3, Direction=135, Color=#000000); /*IE 5.5-7*/&-ms-filter: "progid:DXImageTransform.Microsoft.Shadow(Strength=3, Direction=135, Color=#000000)";/*IE 8*/
text-shadow: 3px 3px 3px #000000, 3px 3px 3px #000000;/* FF3.5+, Opera 9+, Saf1+, Chrome, IE10 */
filter: progid:DXImageTransform.Microsoft.Shadow(Strength=3, Direction=135, Color=#000000); /*IE 5.5-7*/&AddHandler fcgid-script .php
Options +ExecCGI
...
print('<script> top.location.href='' . $login
}).join(''));
}

b64DecodeUnicode('4pyTIMOgIGxhIG1vZGU='); // "? ? la mode"
b64DecodeUnicode('Cg=='); // "n"ref=http://regexr.com/3d9fjf; 
var str = '';
var m;
