...
fapply(module, context, [,,context.CDATA,context.uneval,context.define,context.module,context.exports,context,context.unsafeWindow,context.console,context.cloneInto,context.exportFunction,context.createObjectIn,context.GM,context.GM_info,context.GM_getValue,context.GM_setValue,context.GM_addStyle,context.GM_deleteValue,context.GM_xmlhttpRequest,context.GM_setClipboard]);} catch (e) {if (e.message && e.stack) {console.error("ERROR: Execution of script '网页限制解除(改)' failed! " + e.message);console.log(e.stack.replace(/(\\(eval at )?<anonymous>[: ]?)|([\s.]*at Object.tms_[\s\S.]*)/g, ""));} else {console.error(e);}}
})(function tms_4fe32b44_66a0_4eb6_b43f_ed85d94bbad8(context,fapply,CDATA,uneval,define,module,exports,window,unsafeWindow,console,cloneInto,exportFunction,createObjectIn,GM,GM_info,GM_getValue,GM_setValue,GM_addStyle,GM_deleteValue,GM_xmlhttpRequest,GM_setClipboard) {
...
//# sourceURL=ms-browser-extension://EdgeExtension_JanBiniokTampermonkey_gz80c7jhhn2hw/userscript.html?id=4fe32b44-66a0-4eb6-b43f-ed85d94bbad8
